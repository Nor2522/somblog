...
window.SomBlog = (function () {
  // Single place to update placeholder contact details - used by the
  // Contact page and the post-rating "share on WhatsApp" prompt.
  const config = {
    whatsappNumber: '000000000', // replace with a real number, digits only, country code first
    email: 'hello@somblog.example',
  };
  ...
  const icons = {
    ...
    star: function (filled) {
      ...
      return `<svg viewBox="0 0 24 24" width="26" height="26" fill="${fill}" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>`;
    },
  };
  ...
  return { escapeHtml, relativeTime, formatReadingMinutes, renderPostCard, icons, config };
})();
